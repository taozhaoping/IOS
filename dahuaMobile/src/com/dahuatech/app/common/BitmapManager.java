...
public class BitmapManager {
    ...
    */
    ...
    /** 
    * @Title: loadBitmap 
    * @Description: 加载图片-可设置加载失败后显示的默认图片
    * @param @param url
    * @param @param imageView
