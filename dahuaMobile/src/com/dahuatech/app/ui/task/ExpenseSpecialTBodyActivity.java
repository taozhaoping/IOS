...
import com.dahuatech.app.business.ExpenseSpecialTBodyBusiness;
import com.dahuatech.app.business.FactoryBusiness;
import com.dahuatech.app.common.UIHelper;
import com.dahuatech.app.ui.main.MenuActivity;


public class ExpenseSpecialTBodyActivity extends MenuActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//获取服务地址
		serviceUrl=AppUrl.URL_API_HOST_ANDROID_EXPENSESPECIALTBODYACTIVITY;	
		//获取传递参数信息
	...
	*/
	private void renderListView(List<ExpenseSpecialTBodyInfo> arrayList) {
		...
		if(arrayList.size()==0){ //如果获取不到数据
			UIHelper.ToastMessageLong(ExpenseSpecialTBodyActivity.this, R.string.expensespecialtbody_netparseerror);
			mListView.setAdapter(null);
			return;
		}
		eArrayList.addAll(arrayList);	
		// 使用数据集构造adapter对象
		epAdapter = new ExpenseSpecialTBodyAdapter(ExpenseSpecialTBodyActivity.this, eArrayList,R.layout.expensespecialtbody_layout);
		// 设置XListView的adapter
	...
	*/
	private List<ExpenseSpecialTBodyInfo> getListByPost(String serviceUrl) {
		...
		FactoryBusiness<?> factoryBusiness=FactoryBusiness.getFactoryBusiness(ExpenseSpecialTBodyActivity.this);
		ExpenseSpecialTBodyBusiness eBodyBusiness= (ExpenseSpecialTBodyBusiness)factoryBusiness.getInstance("ExpenseSpecialTBodyBusiness",serviceUrl);
