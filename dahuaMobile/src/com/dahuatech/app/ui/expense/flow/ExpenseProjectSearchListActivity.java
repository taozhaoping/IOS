 ...
 * @Description 流水项目列表页面
 * @author 21291
 * @date 2014年9月1日 上午10:54:42
 */
...
SearchView.OnSuggestionListener,OnRefreshListener<ListView> {
	...
	*/
	 ...
	 * @Description 获取本地项目历史记录集合
	 * @author 21291
	 * @date 2014年9月3日 上午11:01:19
	 */
	...
	* @Description: 获取本地项目历史记录实体集合业务逻辑
	* @param @return     
	* @return List<ExpenseFlowItemInfo>    
	* @throws 
	* @author 21291
	* @date 2014年9月3日 上午11:02:15
	*/
	...
	* @Description: 初始化本地项目历史记录列表
	* @param @param listData     
	* @return void    
	* @throws 
	* @author 21291
	* @date 2014年9月3日 上午11:03:40
	*/
	 ...
	 * @Description 异步获取项目服务器实体集合信息
	 * @author 21291
	 * @date 2014年9月3日 上午11:00:35
	 */
	...
	* @Description: 获取项目服务器实体集合业务逻辑操作
	* @param @param pageIndex
	* @param @return     
	* @return List<ExpenseFlowItemInfo>    
	* @throws 
	* @author 21291
	* @date 2014年9月3日 上午11:07:23
	*/
	...
	private void renderProjectListView(final List<ExpenseFlowItemInfo> listData){
		...
		mPullRefreshListView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				mDbHelper.insertProjectSearch(eInfo); //添加搜索记录到本地数据库中
