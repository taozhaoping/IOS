...
+ (NSString *) encode:(NSString *)str
{
    ...
    NSMutableString* encode = [NSMutableString stringWithString:[DESUtil doCipher:str1 key: @_DES_DEFAULT_KEY_ context:kCCEncrypt]];
...
+ (NSString *) decode:(NSString *)str
{
    ...
    NSString *rt = [DESUtil doCipher:str1 key:@_DES_DEFAULT_KEY_ context:kCCDecrypt];
